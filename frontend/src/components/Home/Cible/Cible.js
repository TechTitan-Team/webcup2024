...
import img1 from "../../../assets/img/sary1.jpg";
import img2 from "../../../assets/img/photo3.jpg";
...
const Cible = () => {
  ...
  <div className="container pt-5 pt-md-0">
    <div className="row">
      ...
      {/* Hero left END */}
      {/* Image START */}
      <div className="col-lg-6 col-xl-6 ms-auto h-100">
        <div className="row align-items-center">
          <div className="col-6 me-sm-n7">
            <div className="position-relative">
              ...
              <img
                ...
                className="rounded-4"
                alt=""
                style={{width: "140%",marginBottom:"9rem"}}
              />
            </div>
          </div>
          <div className="col-6 position-relative">
            {/* Video image */}
            {/* <div className="card card-body overflow-hidden p-0 mb-4 mb-sm-7">
              <img
                src={img2}
                className="card-img"
                alt="video-img"
            ...
            <img
              ...
              className="rounded-4"
              alt=""
              style={{width: "140%",marginTop:"9rem",marginLeft: "-7rem"}}
            />
          </div>
        </div>
      </div>
