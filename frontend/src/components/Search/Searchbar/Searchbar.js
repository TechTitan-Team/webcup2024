    ...
    return <>
        <div className="container mb-4 dis-header">
                    ...
                    <div class="checkbox">
                        <label class="checkbox-wrapper">
                            ...
                            <span class="checkbox-tile">
                                ...
                                <span class="checkbox-label">Espaces</span>
                            </span>
                        </label>
                    </div>
                    <div class="checkbox">
                        <label class="checkbox-wrapper">
                            ...
                            <span class="checkbox-tile">
                                ...
                                <span class="checkbox-label">Services traiteurs</span>
                            </span>
                        </label>
                    </div>
                    <div class="checkbox">
                    ...
                    <div class="checkbox">
                        <label class="checkbox-wrapper">
                            ...
                            <span class="checkbox-tile">
                                ...
                                <span class="checkbox-label">Décorations</span>
                            </span>
                        </label>
                    </div>
                </div>
            ...
            <div className="w-100 my-4">
                <button class="btn btn-primary w-100 fw-bold">C'est parti</button>
            </div>
        </div>
